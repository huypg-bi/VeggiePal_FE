...
export default function ForgotPasswordScreen() {
  return (
    <div className="relative flex min-h-dvh items-center justify-center bg-gradient-to-br from-[#18A575] via-[white] to-[#1E5B53] px-4 py-6 dark:from-[#0d2a1c] dark:via-[#0a140f] dark:to-[#0d1f1a]">
      <ThemeToggle className="absolute right-6 top-6 z-10 bg-white/80 hover:bg-white dark:bg-black/30 dark:hover:bg-black/50" />

      <div className="flex w-full max-w-[420px] flex-col items-center rounded-[32px] bg-[#EEFDEA] px-6 py-6 shadow-[0_20px_25px_-5px_rgba(0,0,0,0.06),0_8px_10px_-6px_rgba(0,0,0,0.04)] dark:bg-[#0f1e16] sm:px-8">
