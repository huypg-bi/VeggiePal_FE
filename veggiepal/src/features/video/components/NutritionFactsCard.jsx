...
export default function NutritionFactsCard() {
  ...
  return (
    <section className="rounded-3xl border border-black/15 bg-white p-5 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <span className="rounded-full bg-[#E8F5E9] px-2.5 py-1 text-[11px] font-semibold text-[#1D6C3D]">
          {servingLabel}
        </span>
      </div>
      ...
      <button
        type="button"
        className="mt-4 flex w-full items-center justify-center gap-2 rounded-full bg-[#1D6C3D] py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#17542F]"
      >
...
function NutritionStat({ value, label, valueClass }) {
  return (
    <div className="rounded-xl bg-[#F5F8F3] px-2 py-2.5">
